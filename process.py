...
class ThresholdModel():
    def __init__(self,
        ...
        if self.debug:
            self._input_path = Path('/data/Dataset/ISLES/22/docker_repo/isles22-docker-submit/test/')
            self._output_path = Path('/data/Dataset/ISLES/22/docker_repo/isles22-docker-submit/test/output/')
