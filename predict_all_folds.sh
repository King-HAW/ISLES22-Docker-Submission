...
if [ `ls $LOWRES_DATA_FOLDER | wc -l` -gt 0 ]; then
    ...
    python $NNUNet_FOLDER"inference/ensemble_predictions.py" --npz -t $THREADS -o ensemble/lowres_predictions -f u_model_l_input_fold0 u_model_l_input_fold1 u_model_l_input_fold2 u_model_l_input_fold3 u_model_l_input_fold4 r_model_l_input_fold0 r_model_l_input_fold1 r_model_l_input_fold2 r_model_l_input_fold3 r_model_l_input_fold4
